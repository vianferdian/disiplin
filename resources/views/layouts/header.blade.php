...
<div class="nav-header">
    <a href="{{ route('dashboard') }}" class="brand-logo d-flex align-items-center">
        <div class="logo-abbr me-2 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px; min-width: 36px;">
        ...
        <div class="brand-title text-start">
            <span class="d-block" style="font-weight: 800; font-size: 18px; letter-spacing: 0.8px; color: #1E33F2; line-height: 1.1;">DISIPLIN</span>
            <small class="d-block text-muted font-w600" style="font-size: 9.5px; white-space: nowrap; line-height: 1.1; margin-top: 2px;">Sistem Kedisiplinan Siswa</small>
        </div>
    </a>
